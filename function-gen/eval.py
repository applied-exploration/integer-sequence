...
class PytorchEval(object):  # pylint: disable=too-few-public-methods
    ...
    def _eval_constant(node):
        ...
        return torch.tensor(float(node.value), requires_grad = True)
...
class EvalWithCompoundTypes(PytorchEval):
    """
